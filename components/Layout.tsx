...
import { FileText, Database, Calculator, GitMerge, LayoutDashboard, Printer, Download } from 'lucide-react';
...
interface LayoutProps {
  ...
  model?: PBIModel | null; // Pass model for export
}

// In App.tsx we need to pass the model to Layout. 
// However, since we can't change App.tsx signature easily without changing App usage, 
// we will rely on App.tsx passing it as a child prop or context if it were complex.
// But here, we can assume Layout is used inside App which has the model.
// Wait, Layout is a wrapper. I will assume App.tsx will be updated to pass the model context if needed.
// Actually, looking at App.tsx, it wraps children. I can add a prop to LayoutProps.
    ...
    <div className="flex h-screen bg-brand-gray overflow-hidden">
      ...
      <aside className="w-64 bg-white shadow-xl flex flex-col z-10 no-print">
        ...
        <div className="p-4 border-t border-gray-100 space-y-2">
             ...
             <p className="text-xs text-center text-gray-400 mt-4">v1.1.0 • Daxilizer 2026</p>
        </div>
      </aside>
